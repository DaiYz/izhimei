package com.izhimei.ReactBridge.uMeng;
...
public class ShareModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void isInstall(final int  sharemedia, final Callback successCallback) {
        boolean install = UMShareAPI.get(getCurrentActivity()).isInstall(getCurrentActivity(), getShareMedia(sharemedia));
        successCallback.invoke(SUCCESS,install);
    }
